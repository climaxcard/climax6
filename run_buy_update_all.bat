...
REM ==================================================
REM Yugioh PSA10 buylist daily update - robust version
REM - Does not stop at startup when local files changed
REM - Publishes to S3/CloudFront even if git pull/push has an issue
REM - S3 target for kaitori.climax-card.com is climax-kaitori-static
REM ==================================================
